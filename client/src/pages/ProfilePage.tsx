...
import { BadgeCheck, Copy, Crown, Flag, Loader2, MapPin, MessageCircle, Share2, ShieldBan, Sparkles, UserPlus, Briefcase, Wrench, Link2, Calendar, CheckCircle } from "lucide-react";
...
export default function ProfilePage() {
  ...
  const saveProfile = async () => {
    try {
      ...
      await update.mutateAsync({ name, handle: handle || undefined, bio, specialty, country, avatarUrl: avatar?.url, coverUrl: cover?.url, experience, skills, tools, portfolioUrl, yearsOfExperience, availability });
